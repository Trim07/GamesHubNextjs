            ...
            <Form>
              ...
              <FloatingLabel label="Senha" className="mb-3">
                <Form.Control 
                  ...
                  placeholder="Senha" 
                  maxLength={100}
                  onBlur={(e)=>setRegisterAccountFormData(prevState=>({...prevState, password: e.target.value}))}
                />
              </FloatingLabel>
              <FloatingLabel label="Confirmar senha" className="mb-3">
                <Form.Control 
                  ...
                  maxLength={100}
                  onBlur={(e)=>setRegisterAccountFormData(prevState=>({...prevState, confirm_password: e.target.value}))}
